...
const navItems = [
  ...
  {
    to: "/admin/projects", label: "Projects", mobileLabel: null,
  ...
  {
    to: "/admin/tasks", label: "Tasks", mobileLabel: null,
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="12" y2="17"/></svg>
  },
  {
    to: "/admin/todo", label: "Todo System", mobileLabel: "Todo",
